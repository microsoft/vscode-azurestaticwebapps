...
import { AzExtFsExtra, nonNullValue, UserCancelledError } from "@microsoft/vscode-azext-utils";
import * as gitUrlParse from 'git-url-parse';
import  { type MessageItem, type ProgressOptions} from 'vscode';
import { commands, env, ProgressLocation, UIKind, Uri, window, workspace } from 'vscode';
