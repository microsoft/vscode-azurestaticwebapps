...
export { createFoldingRanges } from './src/commands/github/logs/createFoldingRanges';
export { LogState, parseGitHubLog } from './src/commands/github/logs/parseGitHubLog';
